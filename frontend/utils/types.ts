...
> =
  Parameters<
    Extract<EventHandler<ElementName, EventName>, (...args: any) => any>
  >[0];
// ...
...
export type SolidStore<T> = [T, SetStoreFunction<T>]
